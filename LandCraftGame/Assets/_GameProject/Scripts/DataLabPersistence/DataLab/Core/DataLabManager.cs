...
namespace DataLab {
	...
	public class DataLabManager : MonoBehaviour {
		...
		private static DataLabManager instance;
		public static DataLabManager Instance { get { return instance; } }

		public DataLabObject LastResponse { get; set; }
		...
		public void SaveObject(DataLabObject obj, System.Action<DataLabObject> asyncResponse) {
		}

		public void LoadObject(string documentName, string attrName, string attrValue, System.Action<DataLabObject> asyncResponse) {
			string URL = restGetURL + "/" + documentName + "/" + attrName + "/" + attrValue;
		...
		public void UpdateObject(DataLabObject obj, System.Action<DataLabObject> asyncResponse) {
		}

		public void PersistObject(DataLabObject obj, System.Action<DataLabObject> asyncResponse) {
			if(obj != null) {
				...
				case ']':
					...
					if (Token != "") {
						...
						if (ctx is JSONArray) {
							...
							ctx.Elements.Add(TokenName, Token);
						}
					}
